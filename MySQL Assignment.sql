CREATE DATABASE SoftrwareHouse;
USE SoftrwareHouse;
...
ALTER TABLE emp
 ...
 CHANGE ename Name VARCHAR(50);

UPDATE emp SET hiredate = DATE_ADD(CURRENT_DATE(), INTERVAL FLOOR(RAND() * 365) DAY);

ALTER TABLE emp ADD COLUMN age INT AFTER department_id;

UPDATE emp SET age = FLOOR(RAND() * 50) + 20;
